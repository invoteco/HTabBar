...
{  
    ...
    public class TabButtonWithDelimiter : WebControl
    {
        ...
        //Определяет, будет ли кнопка иметь разделитель (справа)
        public bool IsDelimitered {
            get { return _IsDelimitered; }
            set { _IsDelimitered = value; }
        }
